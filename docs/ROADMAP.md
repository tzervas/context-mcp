...
| ID | Work |
|----|------|
| C0.1 | Docs: remove “production RAG” claims; crates.io keywords review |
| C0.2 | Semantic mode off by default OR hard-error if no real embedder |
| C0.3 | Token auth for HTTP |
| C0.4 | Align version tags with 0.2.0 story |
| C0.5 | Fix WebSocket/SSE overclaims |
